...
class ILQR_3_State(Controller):
    ...
    def initialize(self, env, max_iterations=50, lamb=0.1, threshold=0.01, loss=None):
        """
        ...
        self.env = env
        self.dim_x, self.dim_u = self.env.get_state_dim(), self.env.get_action_dim()
    ...
    # TODO: move this out of here to a different file
