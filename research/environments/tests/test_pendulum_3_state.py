...
import time
import tigercontrol
from research.controllers.ilqr_pendulum_3_state import ILQR_3_State as ilqr_3_state
import jax.numpy as np
from research.environments.pendulum_3_state import Pendulum_3_State 

# cartpole test
def test_pendulum(verbose=False):
    environment = Pendulum_3_State()
    ...
    controller.initialize(environment, max_iterations, lamb, threshold)
