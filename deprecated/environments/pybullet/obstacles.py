...
class ObstaclesEnv(gym.Env):
    ...
    def reset(self):
        ...
        pybullet.loadURDF(os.path.join(tigercontrol_dir, "environments/pybullet/URDFs/plane.urdf"))

        # Load robot from URDF
        self.husky = pybullet.loadURDF(os.path.join(tigercontrol_dir, "environments/pybullet/URDFs/husky.urdf"), globalScaling=0.5)
...
class Obstacles(PyBulletEnvironment):
    """
