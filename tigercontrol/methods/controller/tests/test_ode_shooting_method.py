# Test the ODEShootingMethod method class by solving x'' = x + 4exp(t) for L = 1
...
def test_ode_shooting_method(steps=10, show_plot=True):
    ...
    method = tigercontrol.method("ODEShootingMethod")
    method.initialize(f, y(0), y(L), 3.0, 4.0, t)
