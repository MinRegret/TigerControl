...
from tigercontrol.methods.controller.control_method import ControlMethod
from tigercontrol.methods.controller.cartpole_weights import *
import math
import numpy as np

class QuadcopterModel(Method):
