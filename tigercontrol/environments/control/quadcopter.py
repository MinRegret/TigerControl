...
class Quadcopter(Environment):
    ...
    def __init__(self):
        ...
        self.state[0:3] = [1,0,4]
        self.state[6:9] = [0,0,0]
        prop_size = [10,4.5] # size of quadcopter
        self.prop1 = self.Propeller(prop_size[0],prop_size[1])
        self.prop2 = self.Propeller(prop_size[0],prop_size[1])
        self.prop3 = self.Propeller(prop_size[0],prop_size[1])
        self.prop4 = self.Propeller(prop_size[0],prop_size[1])
    ...
    def update(self, dt):
        ...
        self.state[6:9] = self._wrap_angle(self.state[6:9])
    ...
    def _state_dot(self, time, state):
        ...
        # The acceleration
        x_dotdot = np.array([0,0,-self.weight*self.g]) + np.dot(self._rotation_matrix(self.state[6:9]),np.array([0,0,(self.prop1.thrust + self.prop2.thrust + self.prop3.thrust + self.prop4.thrust)]))/self.weight
        ...
        tau = np.array([self.L*(self.prop1.thrust-self.prop3.thrust), self.L*(self.prop2.thrust-self.prop4.thrust), self.b*(self.prop1.thrust-self.prop2.thrust+self.prop3.thrust-self.prop4.thrust)])
