...
class QuadcopterSingleP2PEnvironment(Environment):
...
def main():
	...
	quad_environment = QuadcopterSingleP2PEnvironment()
	gui_object, quad_id, quad = quad_environment.initialize(GOALS, YAWS)
	...
	goal_0 = quad_environment.goals[0]
	yaw_0 = quad_environment.yaws[0]
